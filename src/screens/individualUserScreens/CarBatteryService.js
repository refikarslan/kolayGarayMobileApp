...
const carStartStopType = ['Evet', 'Hayır'];

export class CarBatteryService extends Component {
  constructor() {
    super();
    ...
    this.handleBatteryVolt = this.handleBatteryVolt.bind(this);
    this.handleBatteryAmpere = this.handleBatteryAmpere.bind(this);
  ...
  carSelected() {
    const {navigation} = this.props;
    window.selectedCategoryId = 5;
    navigation.navigate('MyGarageCarList');
  }

  firmSelected() {
    const {navigation} = this.props;
    window.commercialCategoryId = 5;
  ...
  carRepairServiceRequest() {
    if (
      ...
      this.state.car_ss_type === null ||
      this.state.battery_volt === null ||
      this.state.battery_ampere === null
    ) {
      Alert.alert(
        'Uyarı !',
      ...
      fetch(CONSTANT.baseUrl + 'request', {
        ...
        body: JSON.stringify({
          ...
          extra: {
            ...
            car_ss_type: this.state.car_ss_type,
            battery_volt: this.state.battery_volt,
            battery_ampere: this.state.battery_ampere,
          },
          commercials:
  ...
  handleBatteryVolt = text => {
    this.setState({battery_volt: text});
  };

  handleBatteryAmpere = text => {
    this.setState({battery_ampere: text});
  };
    ...
    return (
      <KeyboardAvoidingView
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.View3}>
            <Text style={styles.textStandart}>Araç Start/Stop Özelliği</Text>
            <SelectDropdown
              data={carStartStopType}
              onSelect={(selectedItem, index) => {
                console.log(selectedItem, index);
                this.setState({car_ss_type: selectedItem});
              }}
              defaultButtonText={'Start/Stop Akü'}
              buttonTextAfterSelection={(selectedItem, index) => {
                return selectedItem;
              }}
              rowTextForSelection={(item, index) => {
              ...
              rowStyle={styles.dropdown1RowStyle}
              rowTextStyle={styles.dropdown1RowTxtStyle}
              defaultValue={this.state.car_ss_type}
            />
          </View>
          <View style={styles.View4}>
            <Text style={styles.textStandart}>Araç Akü Voltajı</Text>
            <TextInput
              placeholder="Akü Volt değerini giriniz. Örn. 12 (V)"
              placeholderTextColor="#808080"
              style={styles.mailInput}
              textContentType="name"
              onChangeText={this.handleBatteryVolt}
              value={this.state.battery_volt}
            />
          </View>
          <View style={styles.View4}>
            <Text style={styles.textStandart}>Araç Akü Amperi</Text>
            <TextInput
              placeholder="Akü Amper değerini giriniz. Örn. 72 (Ah)"
              placeholderTextColor="#808080"
              style={styles.mailInput}
              textContentType="name"
              onChangeText={this.handleBatteryAmpere}
              value={this.state.battery_ampere}
            />
          </View>
          <View style={styles.View5}>
            ...
            Örn. Aracımın aküsünü değiştireceğim, marka model detayları ile fiyat tekliflerinizi bekliyorum."
              placeholderTextColor="#808080"
