...
export class CarRepairService extends Component {
  constructor() {
    super();
  ...
  carSelected() {
    const {navigation} = this.props;
    window.selectedCategoryId = 4;
    navigation.navigate('MyGarageCarList');
  }

  firmSelected() {
    const {navigation} = this.props;
    window.commercialCategoryId = 4;
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.View5}>
            ...
            Örn. Aracımın periyodik bakımını yaptırmak istiyorum, yada Aracımın ön tamponunu boyatmak istiyorum."
