...
export class CarKeyService extends Component {
  constructor() {
    super();
  ...
  carSelected() {
    const {navigation} = this.props;
    window.selectedCategoryId = 6;
    navigation.navigate('MyGarageCarList');
  }

  firmSelected() {
    const {navigation} = this.props;
    window.commercialCategoryId = 6;
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.View5}>
            ...
            Örn. Aracımın anahtarı kayıp, yolda kaldım acilen yardım bekliyorum."
