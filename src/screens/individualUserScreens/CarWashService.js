...
export class CarWashService extends Component {
  constructor() {
    super();

    this.handleIndex = this.handleIndex.bind(this);
    this.carSelected = this.carSelected.bind(this);
    this.carWashRequestService = this.carWashRequestService.bind(this);
    this.carDetailingRequestService =
      this.carDetailingRequestService.bind(this);
    this.firmSelected = this.firmSelected.bind(this);

    this.state = {
      index: 0,
      routes: [
        {key: 'carWash', title: 'OTO YIKAMA'},
        {key: 'carDetail', title: 'OTO KUAFÖR'},
      ],
      spinner: false,
      firmNameLabel: null,
      selectedIlce: [],
  ...
  firmSelected() {
    const {navigation} = this.props;
    window.commercialCategoryId = 2;
    navigation.navigate('CommercialUsersList');
  }

  carWashRequestService() {
    if (
      window.car_type === undefined ||
      window.location_city === undefined ||
      window.location_state === undefined ||
      this.state.description === null ||
      window.wash_type === undefined ||
      window.wash_engine === undefined ||
      window.wash_seat === undefined ||
      window.wash_disenfection === undefined ||
      ...
      let bodyParameter = {
        ...
        longitude: null,
        extra: {
          wash_type: window.wash_type,
          wash_engine: window.wash_engine,
          wash_seat: window.wash_seat,
          wash_disenfection: window.wash_disenfection,
              ...
              [
                {
                  ...
                  onPress: () => {
                    ...
                    window.wash_type = null;
                    window.wash_engine = null;
                    window.wash_seat = null;
                    window.wash_disenfection = null;
    ...
    return (
      <>
        <Tab
          ...
          variant="primary">
          <Tab.Item title="OTO YIKAMA" titleStyle={{fontSize: 12}} />
          <Tab.Item title="OTO KUAFÖR" titleStyle={{fontSize: 12}} />
        </Tab>
        <ScrollView>
          <TabView
            value={index}
              ...
              <KeyboardAvoidingView
                ...
                <ScrollView style={{flex: 1, backgroundColor: '#ffffff'}}>
                  ...
                  <View style={styles.View3}>
                    <Text style={styles.textStandart}>Araç Yıkama Türü</Text>
                    <SelectDropdown
                      data={carWashTypeList}
                      onSelect={(selectedItem, index) => {
                        console.log(selectedItem, index);
                        if (selectedItem === 'İç - Dış Yıkama') {
                          window.wash_type = 'INT_EXT';
                        } else if (selectedItem === 'Sadece Dış Yıkama') {
                          window.wash_type = 'EXTERIOR';
                        } else if (selectedItem === 'Sadece İç Yıkama') {
                          window.wash_type = 'INTERIOR';
                        } else {
                          window.wash_type = 'FULL_DETAIL';
                        }
                      }}
                      defaultButtonText={'Yıkama Tipi Seçiniz'}
                      buttonTextAfterSelection={(selectedItem, index) => {
                        return selectedItem;
                      }}
                      rowTextForSelection={(item, index) => {
                    ...
                    <SelectDropdown
                      ...
                      onSelect={(selectedItem, index) => {
                        ...
                        if (selectedItem === 'Evet İstiyorum') {
                          window.wash_engine = 1;
                        } else if (selectedItem === 'Hayır İstemiyorum') {
                          window.wash_engine = 0;
                        }
                      }}
                  ...
                  <View style={styles.View4}>
                    ...
                    <SelectDropdown
                      ...
                      onSelect={(selectedItem, index) => {
                        console.log(selectedItem, index);
                        if (selectedItem === 'Evet İstiyorum') {
                          window.wash_disenfection = 1;
                        } else if (selectedItem === 'Hayır İstemiyorum') {
                          window.wash_disenfection = 0;
                        }
                      }}
                      defaultButtonText={'Lütfen Seçim Yapınız'}
                      buttonTextAfterSelection={(selectedItem, index) => {
                  ...
                  <View style={styles.signUpButtonView}>
                    <TouchableOpacity
                      style={styles.button}
                      onPress={this.carWashRequestService}>
              ...
              <KeyboardAvoidingView
                ...
                <ScrollView style={{flex: 1, backgroundColor: '#ffffff'}}>
                  ...
                  <View style={styles.View5}>
                    ...
                    <TextInput
                      placeholder="Oluşturacağınız hizmet talebinize dair detaylı açıklama girebilirsiniz.
            Örn. Aracıma Pasta-Cila Boya Koruma yaptırmak istiyorum."
                      placeholderTextColor="#808080"
                      style={styles.detailInput}
                      textContentType="name"
                      onChangeText={e => this.setState({description: e})}
                  ...
                  <View style={styles.signUpButtonView}>
                    <TouchableOpacity
                      style={styles.button}
                      onPress={this.carDetailingRequestService}>
                      <View style={styles.kayitOlRow}>
                        <Text style={styles.kayitOl}>Hemen Hizmet Al</Text>
                      </View>
                    </TouchableOpacity>
